...
# next pos  screenshot_109

import cv2

# Read an image
image = cv2.imread('game_screenshots\screenshot_109.png')
...
# Draw a rectangle around the ROI on the original image
displaced_x = x + velocity_crop
cv2.rectangle(image, (displaced_x, y), (displaced_x + width, y + height), (0, 255, 0), 2)  # Green rectangle, thickness = 2
cv2.rectangle(image, (displaced_x, y), (displaced_x + width, y + head_crop), (255, 0, 0), 2)  # Green rectangle, thickness = 2
